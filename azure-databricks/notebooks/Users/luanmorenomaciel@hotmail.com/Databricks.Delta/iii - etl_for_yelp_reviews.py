...
[StructField('business_id', StringType(), True), StructField('cool', LongType(), True), StructField('date', DateType(), True), StructField('funny', LongType(), True), StructField('review_id', StringType(), True), StructField('stars', LongType(), True), StructField('text', StringType(), True), StructField('useful', LongType(), True), StructField('user_id', StringType(), True)]
)
...
query = (
  StreamingDfReviews
    ...
    .format("delta")  
    .outputMode("append")
    .option("checkpointLocation", "/delta/ss_reviews/_checkpoint/etl-from-json")
    .start("/delta/ss_reviews")
)
